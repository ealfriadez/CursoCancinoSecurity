...
import pe.edu.unfv.persistence.entity.security.PermissionEntity;
...
public class DataProvider {
	...
	public static List<CategoriasModel> categoriasModelListMock() {
		...
		return List.of(new CategoriasModel(1, "Lionel Messi", "Inter Miami"),
	...
	public static List<ProductosModel> productosModelListMock() {
		...
		return List.of(new ProductosModel(1, "Lionel Messi", "Inter Miami", "Jugado 1", 8500, "mesi", "united"),
	...
	public static ProductosModel productosModelMockCategory_() {
		...
		return new ProductosModel(1, "Lionel Messi", "Inter Miami", "Jugado 1", 8500, "mesi.jpg", "united",
				arraytoinsert, categoriaId);
	}
	...
	public static Optional<ProductosModel> productsOptionalModelMock() {
		...
		ProductosModel productosModel = new ProductosModel(1, "Lionel Messi", "Inter Miami", "Jugado 1", 8500, "mesi",
				"united");
	...
	public static Optional<UserEntity> userEntityModelMock() {
		...
		UserEntity userEntity = new UserEntity(1L, "Eleazar Alfredo", "ealfriadez@gmail.com", username, false, false,
				false, false, roles);

		RoleEntity role = new RoleEntity(1L, RoleEnum.USER, permission);
		PermissionEntity permissionEntity = new PermissionEntity(1L, "PERMISSION_READ");
		userEntity.getRoles().add(role);
		role.getPermissionList().add(permissionEntity);
	...
	public static UserDetails userDetailsEntityModelNullMock() {

		return null;
	}
	
	public static UserEntity userEntityModelNullMock() {
